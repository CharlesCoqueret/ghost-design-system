...
import portfolioStyle from '../../../assets/_portfolio.scss?raw';
...
In order to use this component, please surround it with a [QueryClientProvider](https://react-query-v3.tanstack.com/reference/QueryClientProvider)
...
[source](https://github.com/CharlesCoqueret/ghost-design-system/blob/main/src/assets/_portfolio.scss)

<Source language='css' dark format={true} code={portfolioStyle} />
