...
import { IColumnType } from '../StaticDataTable';
import { ColumnType, IExtraLineEditableDataTableProps } from '../StaticDataTable/types';
...
const LineEditableModal = <T,>(props: ILineEditableModalProps<T>): ReactElement => {
  ...
  return (
    <Modal show={true} title={title} closeIcon={false} closeOnClickEscape={false} closeOnClickOutide={false} size='lg'>
