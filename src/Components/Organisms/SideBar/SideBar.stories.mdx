...
<ArgsTable of={SideBar} sort='requiredFirst' exclude={['unfixed']} />

## SideBarSection

<Canvas withSource='open'>
  <Story name='SideBarSection'>
...
<Canvas withSource='open'>
  <Story name='SideBarSection and SideBarItem'>
