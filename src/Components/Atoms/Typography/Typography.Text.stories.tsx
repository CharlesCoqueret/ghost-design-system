    ...
    <>
      ...
      <Section title='Your own example here:' collapsible={false} separator={false}>
        <Typography.Text {...arg}>
          ...
          aut neque saepe vel consectetur enim aut cumque neque. Et voluptate sapiente quisquam quasi eum beatae
          voluptas rem iure velit. Sed impedit eaque 33 natus nihil est quaerat porro est quia nisi qui doloribus
          aperiam. Sit culpa illum ea consectetur perspiciatis ex veritatis dolorem id velit sequi qui maiores
          asperiores!
        </Typography.Text>
      </Section>
    </>
