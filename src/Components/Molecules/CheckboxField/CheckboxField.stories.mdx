...
export const Template = (args) => {
  ...
  return <CheckboxField {...args} input={val} onChange={setVal} />;
};

<Canvas withSource='open'>
  <Story name='CheckboxField' args={{ label: 'Checkbox field', input: options }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Template label='Checkbox field in error' errorMessage='This text is on error' input={options} />
</Canvas>

### Helper

<Canvas>
  <Template helperText='Helper text' label='Checkbox field with helper and counter' mandatory={true} input={options} />
</Canvas>
...
<Canvas>
  <Template disabled={true} helperText='Helper text' label='Checkbox field disabled' input={options} />
</Canvas>

### Inline

<Canvas>
  <Template label='Checkbox field in line' inline={true} input={[options[0], options[1]]} />
</Canvas>
