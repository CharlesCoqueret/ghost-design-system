...
<Meta
  title='Molecule/DateTimePickerField'
...
export const Template = (args) => {
  ...
  return <DateTimePickerField {...args} timeFormat='hh:mm:ss' input={val} onChange={setVal} />;
};
...
<ArgsTable of={DateTimePickerField} sort='requiredFirst' exclude={['dataTestId']} />
